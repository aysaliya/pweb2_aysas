                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" action="/pemesanan/store" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_pembeli" value="{{$pemesanan->nama_pembeli}}" class="form-control" id="exampleInputUsername1" placeholder="Nama" disabled />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nama Menu</label>
                                                <input type="text" name="nama_menu" value="{{$pemesanan->nama_menu}}" class="form-control" id="exampleInputUsername1" placeholder="Nama" disabled />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Harga</label>
                                                <input type="text" name="harga" value="{{$pemesanan->harga}}" class="form-control" id="exampleInputUsername1" placeholder="Harga" disabled />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Jumlah Pesanan</label>
                                                <input type="text" name="jumlah" value="{{$pemesanan->jumlah}}" class="form-control" id="exampleInputUsername1" placeholder="Jumlah" disabled />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Catatan</label>
                                                <input type="text" name="catatan" value="{{$pemesanan->catatan}}" class="form-control" id="exampleInputUsername1" placeholder="Catatan" disabled s />
                                            </div>
                                        </form>
                                    </div>
                                </div>
